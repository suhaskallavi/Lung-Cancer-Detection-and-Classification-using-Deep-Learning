@echo off
rem INTELF12MSSDK71OPTS.BAT
rem
rem    Compile and link options used for building MEX-files using the
rem    Intel? Fortran Compiler 12 with Microsoft Software Development Kit 7.1
rem    
rem
rem StorageVersion: 1.0
rem FortrankeyFileName: INTELF12MSSDK71OPTS.BAT
rem FortrankeyName: Intel Visual Fortran
rem FortrankeyManufacturer: Intel
rem FortrankeyVersion: 12 
rem FortrankeyLanguage: Fortran
rem FortrankeyLinkerName: Microsoft SDK
rem FortrankeyLinkerVersion: 7.1
rem
rem    $Revision: 1.1.6.4 $  $Date: 2012/07/23 18:50:37 $
rem
rem ********************************************************************
