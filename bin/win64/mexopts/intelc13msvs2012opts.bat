@echo off
rem INTELC13MSVS2012OPTS.BAT
rem
rem    Compile and link options used for building MEX-files using the
rem    Intel? C++ 13.0 compiler with the Microsoft? Visual Studio? 2012
rem    SP1 Professional Edition linker
rem
rem StorageVersion: 1.0
rem C++keyFileName: INTELC13MSVS2012OPTS.BAT
rem C++keyName: Intel C++
rem C++keyManufacturer: Intel
rem C++keyVersion: 13.0
rem C++keyLanguage: C++
rem C++keyLinkerName: Microsoft Visual Studio 2012
rem C++keyLinkerVersion: 11.0
rem
rem    $Revision: 1.1.6.1 $  $Date: 2012/09/25 18:20:12 $
rem
rem ********************************************************************
