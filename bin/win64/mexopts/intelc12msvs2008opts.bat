...
rem    Intel? C++ 12.0 compiler with the Microsoft? Visual Studio? 2008
...
rem C++keyLanguage: C++
rem C++keyLinkerName: Microsoft Visual Studio 2008
rem C++keyLinkerVersion: 9.0
rem
rem    $Revision: 1.1.6.3 $  $Date: 2012/07/23 18:50:33 $
rem
rem ********************************************************************
